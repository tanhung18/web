    ...
    <?php
		...
		if(isset($_SESSION['product'])){
			...
			foreach($_SESSION['product'] as $cart_itm){
				...
				echo '<p style="font-weight:bold">Product Name:'.$cart_itm['name'].'</p>';
			    ...
			    echo '<p style="font-weight:bold">Product Code:'.$cart_itm['id'].'</p>';
			    echo '<p>Produce Qty:'.$cart_itm['qty'].'</p>';
				echo '<p>Product Price:'.$cart_itm['price'].'</p>';
